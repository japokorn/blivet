...
Recommends: (libblockdev-btrfs >= %{libblockdevver} if btrfs-progs)
Recommends: libblockdev-crypto >= %{libblockdevver}
Recommends: (libblockdev-dm >= %{libblockdevver} if dmraid)
Recommends: (libblockdev-fs >= %{libblockdevver} if device-mapper-multipath)
Recommends: (libblockdev-kbd >= %{libblockdevver} if bcache-tools)
Recommends: libblockdev-loop >= %{libblockdevver}
Recommends: (libblockdev-lvm >= %{libblockdevver} if lvm2)
Recommends: (libblockdev-mdraid >= %{libblockdevver} if mdadm)
Recommends: (libblockdev-mpath >= %{libblockdevver} if device-mapper-multipath)
Recommends: (libblockdev-part >= %{libblockdevver} if device-mapper-multipath)
Recommends: libblockdev-swap >= %{libblockdevver}
Recommends: (libblockdev-s390 >= %{libblockdevver} if s390utils)
